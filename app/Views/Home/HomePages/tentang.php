...
<section class="page-section">
    <div class="container">
        <img class="mb-5" src="/template/leramiz/img/about.jpg" alt="">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="member-pic">
                            <img src="/template/leramiz/img/team/1.jpg" alt="#">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="member-pic">
                            <img src="/template/leramiz/img/team/2.jpg" alt="#">
                            <div class="member-social">
                                <a href=""><i class="fa fa-facebook"></i></a>
                                <a href=""><i class="fa fa-instagram"></i></a>
                                <a href=""><i class="fa fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="member-pic">
                            <img src="/template/leramiz/img/team/3.jpg" alt="#">
                            <div class="member-social">
                                <a href=""><i class="fa fa-facebook"></i></a>
                                <a href=""><i class="fa fa-instagram"></i></a>
                                <a href=""><i class="fa fa-twitter"></i></a>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="team-member">
                        <div class="member-pic">
                            <img src="/template/leramiz/img/team/4.jpg" alt="#">
                            <div class="member-social">
                                <a href=""><i class="fa fa-facebook"></i></a>
                                <a href=""><i class="fa fa-instagram"></i></a>
                                <a href=""><i class="fa fa-twitter"></i></a>
