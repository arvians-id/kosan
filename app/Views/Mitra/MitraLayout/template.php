...
<head>
    ...
    <!-- Custom Theme Style -->
    <link href="/template/gant/vendors/build/css/custom.min.css" rel="stylesheet">
</head>
...
<body class="nav-md">
    ...
    <!-- jQuery Smart Wizard -->
    <script src="/template/gant/vendors/jQuery-Smart-Wizard/js/jquery.smartWizard.js"></script>
